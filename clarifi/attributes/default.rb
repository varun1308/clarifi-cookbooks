...
default['tourient']['site_name'] = 'tourient'
default['tourient']['host_header'] = 'tourient.com'
default['tourient']['port'] = 80
default['tourient']['protocol'] = :http
default['tourient']['site_base_directory'] = "#{ENV['SYSTEMDRIVE']}\\inetpub\\wwwroot"
